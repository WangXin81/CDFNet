...
#num_classes = 6
#ST_COLORMAP = [[255,255,255], [255, 0, 0], [128,128,128], [0,128,0], [0,255,0], [0, 0, 255]]
#ST_CLASSES = ['unchanged', 'water', 'ground', 'low vegetation', 'tree', 'building']

num_classes = 6
ST_COLORMAP = [[255,255,255], [0,0,255], [128,128,128], [0,128,0], [0,255,0], [128,0,0], [255,0,0],[255,255,0]]
ST_CLASSES = ['unchanged', 'water', 'ground', 'low vegetation', 'tree', 'building', 'sports field','else']
...
class Data_test(data.Dataset):
    def __init__(self, test_dir):
        ...
        print("imgA_dir:", imgA_dir)
        print("imgB_dir:", imgB_dir)
